        ...
        <b-modal id="delete-round"  hide-footer  centered visible-close>
            <template>
                <div class="container">
                    ...
                    <div class="row pr-3 pl-3">
                        <div class="col-12">
                            <p class="pt-3">Are you sure you want to <b>delete this round?</b> By doing so you will lose all questions and  `answers pertaining to this round.</p>
                        </div>
                    </div>
                    <div class="row mt-3 trivalo-background p-3">
