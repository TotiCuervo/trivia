    ...
    <div>
        ...
        <div class="row pb-3 pt-3 host-subHeader">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <!--left-->
                    <h6 class="mb-0 flex-grow-1">Game Over</h6>

                    <!--right-->
                    <b-button pill variant="primary" class="float-right" @click="goToGameLobby()">Game Lobby</b-button>
                </div>
            </div>
        </div>
        <!--Top 3-->
        <div class="row pt-3 justify-content-center">
            <div class="col-12 col-sm-4 col-md-3 text-center">
                ...
                <div class="row">
                    <div class="col-12">
                        <h3>{{this.teams[0].name}}</h3>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-4 col-md-3 text-center" v-if="this.teams.length >= 2">
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        <h3>{{this.teams[1].name}}</h3>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-4 col-md-3 text-center" v-if="this.teams.length >= 3">
                <div class="row">
                    <div class="col-12">
...
<script>
    ...
    export default {
        ...
        methods: {
            goToGameLobby() {
                this.currentPage = "HostGameLobby";
            }
        },
        computed: {
